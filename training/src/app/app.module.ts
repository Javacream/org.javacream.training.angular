...
import {UtilModule, ReverseModule} from '@javacream/util'
@NgModule({
  declarations: [
    AppComponent,
    HeaderComponent,
  ...
  imports: [
    BrowserModule, FormsModule, ReactiveFormsModule, HttpClientModule, BookRoutingModule, UtilModule, ReverseModule
  ],
  providers: [],
